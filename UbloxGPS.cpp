...
int Ublox::setNavEngine()
{
    ...
    int gps_naveng_length = (sizeof(gps_naveng)/sizeof(*gps_naveng));
    unsigned char from_gps_data_nav[gps_naveng_length];

    return SPIdev::transfer(spi_device_name.c_str(), gps_naveng, from_gps_data_nav, gps_naveng_length, 5000000);
}
